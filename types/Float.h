...
///
/// @file       Float.h
/// @brief      Declaration of the Float type class.
/// @author     Patrick Flick
///

#include "Type.h"

#ifndef __DCPU_CC_TYPES_FLOAT_H
#define __DCPU_CC_TYPES_FLOAT_H
...
namespace dcpucc
{
    namespace types
    {
        ...
        ///
        /// @class      Float
        /// @brief      The Float type class.
        ///
        class Float : public FloatType
        {
        ...
        public:
            ///
            /// @brief      The constructor of the Float type class.
            ...
            ///
            /// @brief      The destructor of the Float type class.
            ///
            virtual ~Float();
        };
