...
///
/// @file       ScalarType.h
/// @brief      Declaration of the ScalarType type class.
...
namespace dtcc
{
    namespace types
    {
        ...
        ///
        /// @class      ScalarType
        /// @brief      The ScalarType type class.
        ///
        ...
        public:
            ///
            /// @brief      The constructor of the ScalarType type class.
            ...
            ///
            /// @brief      The destructor of the ScalarType type class.
            ///
            virtual ~ScalarType();
        };
