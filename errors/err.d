...
ERR_CC_STRUCT_BITFIELD_NON_CONST                     cc-struct-bitfield-non-const             "the size of a bitfield must be a constant expression"
ERR_CC_STRUCT_BITFIELD_NEG                           cc-struct-bitfield-neg                   "the size of a bitfield cannot be negative"
ERR_CC_STRUCT_BITFIELD_TOO_BIG                       cc-struct-bitfield-too-big               "the size of a bitfield cannot be bigger than the system word size"
ERR_CC_STRUCT_BITFIELD_NO_INT                        cc-struct-bitfield-no-int                "the type of a bitfield must be of signed or unsigned int"
ERR_CC_STRUCT_UNNAMED_BITFIELD                       cc-struct-unnamed-bitfield               "unnamed bitfield can only be of size 0 (padding to next word)"
ERR_CC_UNION_BITFIELD                                cc-union-bitfield                        "a union cannot have a bitfield member"
