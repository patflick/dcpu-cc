...
///
/// @file       Int32.h
/// @brief      Declaration of the Int32 class.
/// @author     Patrick Flick
///

#ifndef __DCPU_CC_CODEGEN_TYPEIMPL_INT32_H
#define __DCPU_CC_CODEGEN_TYPEIMPL_INT32_H
